...
import { 
  ...
  MapPin, ArrowRight, Star, AlertTriangle, 
  Cpu, Award 
} from 'lucide-react';
    ...
    <div className="bg-background min-h-screen flex flex-col font-sans">
      ...
      <header className="glass-nav sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link 
              to="/auth" 
              className="bg-primary hover:bg-primary-hover text-white px-4 py-2 rounded-xl text-sm font-bold shadow-premium transition-all"
            >
              Get Started
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-3 sm:space-y-0 sm:space-x-4">
              <Link 
                to="/auth" 
                className="w-full sm:w-auto bg-gradient-to-r from-primary to-emerald-500 hover:brightness-105 text-white px-8 py-3.5 rounded-xl font-bold shadow-premium flex items-center justify-center space-x-2 transition-all"
              >
              ...
              <Link 
                to="/map" 
                className="w-full sm:w-auto bg-secondary text-foreground hover:bg-secondary/80 border border-border px-8 py-3.5 rounded-xl font-bold transition-all flex items-center justify-center space-x-2"
              >
          ...
          <div className="relative mx-auto max-w-md lg:max-w-none w-full animate-fade-in-up">
            <div className="glass-card border border-border/80 rounded-2xl p-6 shadow-2xl relative overflow-hidden bg-card/70">
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="glass-card p-8 rounded-2xl border border-border/80 text-center hover:scale-[1.02] transition-transform duration-300">
          ...
          <div className="glass-card p-8 rounded-2xl border border-border/80 text-center hover:scale-[1.02] transition-transform duration-300">
            <div className="w-12 h-12 bg-emerald-500/10 rounded-xl flex items-center justify-center text-emerald-500 mx-auto mb-6">
          ...
          <div className="glass-card p-8 rounded-2xl border border-border/80 text-center hover:scale-[1.02] transition-transform duration-300">
            <div className="w-12 h-12 bg-amber-500/10 rounded-xl flex items-center justify-center text-amber-500 mx-auto mb-6">
      ...
      <section className="bg-secondary/20 py-20 border-t border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-card p-6 rounded-2xl border border-border shadow-premium space-y-4">
              ...
              <p className="text-xs text-muted-foreground italic">"Reported an overflowing garbage dump in front of our housing society. The community verified it, and municipal sanitation trucks cleared it within 24 hours!"</p>
            ...
            <div className="bg-card p-6 rounded-2xl border border-border shadow-premium space-y-4">
              ...
              <p className="text-xs text-muted-foreground italic">"As a certified verifier, I review reports during my evening walks. It feels great to be part of the solution and help filter out duplicates using the AI matching engine."</p>
              <div className="flex items-center space-x-2 pt-2 border-t border-border/50">
                <div className="w-8 h-8 rounded-full bg-slate-300" />
                <div>
            ...
            <div className="bg-card p-6 rounded-2xl border border-border shadow-premium space-y-4">
              ...
              <p className="text-xs text-muted-foreground italic">"Having a localized dashboard allows us to plan repair runs much more efficiently. We saved hours by batching street light fixes in Sector 30."</p>
              <div className="flex items-center space-x-2 pt-2 border-t border-border/50">
                <div className="w-8 h-8 rounded-full bg-slate-300" />
                <div>
      ...
      <section className="bg-gradient-to-tr from-primary to-emerald-600 py-16 text-center text-white relative overflow-hidden border-t border-border">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-6">
          ...
          <Link 
            to="/auth" 
            className="inline-flex items-center space-x-2 bg-white text-primary hover:bg-slate-100 px-8 py-3.5 rounded-xl font-extrabold shadow-lg transition-all"
          >
